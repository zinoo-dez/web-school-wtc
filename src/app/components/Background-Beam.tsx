...
export default function BackgroundBeamsDemo() {
    return (
        <>
            ...
            <div className="min-h-[90vh] w-full rounded-md bg-neutral-950 dark:bg-neutral-900   antialiased">
                <Nav />
                <div className="min-h-[80vh] relative flex items-center justify-center flex-col">
